...
function Card({isDarkModeActive}: CardProps) {
  ...
  return (
    <div>
        <h2 className={isDarkModeActive ? "header light-text" : "header"} data-testid="header">Visa Card</h2>
          ...
          >
            {({ values, isSubmitting }) => (
              <Form className='card-fields'  data-testid="card-fields">
                ...
                <Field className='card-field' name="cardNumber" type="text" data-testid="cardNumberInput" />
                ...
                <button className={isDarkModeActive ? "submit-btn light-btn": "submit-btn dark"} type="submit" disabled={isSubmitting} data-testid="submit-btn">Submit</button>
              </Form>
            )}
          </Formik>
        </div>
